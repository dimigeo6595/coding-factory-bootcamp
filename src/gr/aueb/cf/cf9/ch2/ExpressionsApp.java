...
public class ExpressionsApp {
    public static void main(String[] args) {
        ...
        sub = num1 - num2;
        mul = num1 * num2;
        div = num1 / num2; //διαίρεση ακεραίων δίνει πάντα ακέραιο
        mod = num1 % num2; // Υπόλοιπο της διαίρεσης
        ...
        System.out.printf("Result4: %d, Result5: %d", result4, result5);

        result6 = (num1 + num2) + (result1 /  result2) + (result3 % result4);

        System.out.printf("Result6: %d", result6);
